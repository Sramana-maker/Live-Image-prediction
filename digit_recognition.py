...
import PIL.ImageOps
import os, ssl, time #operating_system, secure_socket_layer
...
while(True):
  ...
  try:
    ...
    upper_left = (int(width / 2 - 56), int(height / 2 - 56)) #limit of y-axis
    bottom_right = (int(width / 2 + 56), int(height / 2 + 56)) #limit of x-axis
